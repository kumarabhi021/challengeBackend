...
googleapis_1.google
    ...
    (_a = data.items) === null || _a === void 0 ? void 0 : _a.forEach(function (item) {
        var _a;
        console.log((_a = item.liveStreamingDetails) === null || _a === void 0 ? void 0 : _a.activeLiveChatId);
    });
});
